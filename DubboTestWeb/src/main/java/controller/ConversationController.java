...
public class ConversationController {
    ...
    @Autowired
    public ConversationController(WebSocketMessageBrokerStats webSocketMessageBrokerStats) {
    ...
    public List<ConversationDTO> getConversation(@RequestParam(defaultValue = "1")int pageNum, @RequestParam(defaultValue = "20")int pageSize){
        return conversationService.findAllConversation(new PageConverter(pageNum-1, pageSize));
    }
